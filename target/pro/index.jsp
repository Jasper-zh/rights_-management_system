...
<%--顶部--%>
<div data-options="region:'north'" style="height:85px; background: #ec4e00; padding: 20px 20px">
    <img src="/static/images/main_logo.png" alt="" style="height: 40px">
    <div style="position: absolute; right: 50px; top: 30px;">
        ...
        <a style="font-size: 14px; color: white;text-decoration: none;" href="${pageContext.request.contextPath}/logout">注销</a>
    </div>
</div>
<%--底部--%>
